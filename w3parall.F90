...
#endif
    !/
    !/ End of SYNCHRONIZE_IPGL_ETC_ARRAY ------------------------------- /
    !/
...
#endif
    !/
    !/ End of SYNCHRONIZE_GLOBAL_ARRAY ---------------------------------- /
    !/
