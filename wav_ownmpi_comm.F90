...
contains
  ...
  subroutine InitializeRealize(gcomp, importState, exportState, clock, rc)
    ...
    character(23)                  :: dtme21
    integer                        :: iam, mpi_comm, mpi_comm_out, num_threads
    ...
    call MPI_Comm_dup(mpi_comm, mpi_comm_out, ierr)
    ...
    if (multigrid) then
      ...
      call waveinit_ufs(gcomp, stdout, ntrace, mpi_comm_out, mds, rc)
      if (ChkErr(rc,__LINE__,u_FILE_u)) return
    end if
#else
    time = time0
