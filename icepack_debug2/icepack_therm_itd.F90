...
!          Elizabeth C. Hunke, LANL
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX2 start linear_itd ',ijb(1:2),vicen,aicen
      do n = 1, ncat
         donor(n) = 0
         daice(n) = c0
         dvice(n) = c0
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX2a linear_itd ',ijb(1:2),vicen,aicen
      do n = 1, ncat
      ...
      hbnew(0) = hin_max(0)
      if(badpnt) print '(a,2i5,10g14.7)','XXX2b linear_itd ',ijb(1:2),vicen,aicen
      do n = 1, ncat-1
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX2c linear_itd ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ! Compute hbnew(ncat)
      !-----------------------------------------------------------------
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX2d linear_itd ',ijb(1:2),vicen,aicen
      ...
      if (remap_flag) then
         if (badpnt) print '(a,2i5,a)','XXX0 remap_flag is true ',ijb(1:2),' will call shift_ice inside linear_itd'
      !-----------------------------------------------------------------
      ! Compute g(h) for category 1 at start of time step
      ! (hicen = hicen_init)
      !-----------------------------------------------------------------

         if(badpnt) print '(a,2i5,10g14.7)','XXX0 b4 fit_line ',ijb(1:2),vicen,aicen
         ...
         if(badpnt) print '(a,2i5,10g14.7)','XXX0 af fit_line ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
         ...
         if(badpnt) print '(a,2i5,10g14.7)','XXX0 af chk aicen(1) ',ijb(1:2),vicen,aicen
      ...
      !-----------------------------------------------------------------
         ...
         if(badpnt) print '(a,2i5,10g14.7)','XXX0 n=1,ncat start ',ijb(1:2),vicen,aicen
         do n = 1, ncat-1
         ...
         enddo                     ! boundaries, 1 to ncat-1
         if(badpnt) print '(a,2i5,10g14.7)','XXX0 boundaries, 1 to ncat-1 ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
...
!                  trcrn(k,n) = trcrn(k,n) - rhosmin
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX0 done with linear_itd'
