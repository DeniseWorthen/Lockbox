...
! author: William H. Lipscomb, LANL
      ...
      if(badpnt) print '(a,2i5,10g14.7)','AAA1 start dynridg ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      rdg_iteration: do niter = 1, nitermax
         if(badpnt) print '(a,3i5,10g16.7)','AAA2a dynridg iter ',niter,ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
         ...
         call ridge_itd (aice0,                   &
                         ...
                         mraftn)
         if (icepack_warnings_aborted(subname)) return
         if(badpnt) print '(a,3i5,10g16.7)','AAA2b dynridg iter ',niter,ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
         ...
         call ridge_shift (dt,          hin_max,     &
                           ...
                           mbio)
         if (icepack_warnings_aborted(subname)) return
         if(badpnt) print '(a,3i5,10g16.7)','AAA2c dynridg iter ',niter,ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
               ...
               if (krdg_redist == 0) then ! Hibler 1980 formulation
                  ...
                  if (nr < ncat) then
                     ...
                     if (hi1 >= hin_max(nr)) then
                        ...
                        if(badpnt) print '(a,3i5,9g15.7)','shiftridge ',ijb(1:2),nr,hL,hR,expL,expR,&
                             farea,fvol,(hL + hexp)*expL,(hR + hexp)*expR,(hL + hexp)*expL - (hR + hexp)*expR
                     endif
...
!autodocument_end
      ...
      if(badpnt) print '(a,3i5,2L)','YYY6al ridge_ice ',istep,ijb(1:2),ldocleanup, ldorebin
      if(badpnt) print '(a,3i5,10g15.7)','YYY6a ridge_ice ',istep,ijb(1:2),(vicen(n),n=1,5),(aicen(n),n=1,5)
      !-----------------------------------------------------------------
      ...
      call ridge_ice (dt,           ndtd,           &
                      ...
                      closing )
      if (icepack_warnings_aborted(subname)) return
      if(badpnt) print '(a,3i5,2L)','YYY6bl ridge_ice ',istep,ijb(1:2),ldocleanup, ldorebin
      if(badpnt) print '(a,3i5,10g15.7)','YYY6b ridge_ice ',istep,ijb(1:2),(vicen(n),n=1,5),(aicen(n),n=1,5)
      ...
      if (ldocleanup) then
         if(badpnt) print '(a,3i5,10g15.7)','YYY7a cleaupitd ',istep,ijb(1:2),(vicen(n),n=1,5),(aicen(n),n=1,5)
         ...
         call cleanup_itd(dtt,                hin_max,          &
                        ...
                        dorebin = ldorebin)
         if (icepack_warnings_aborted(subname)) return
         if(badpnt) print '(a,3i5,10g15.7)','YYY7b cleanupitd ',istep,ijb(1:2),(vicen(n),n=1,5),(aicen(n),n=1,5)
      endif
