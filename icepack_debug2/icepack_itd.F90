...
! authors: William H. Lipscomb and Elizabeth C. Hunke, LANL
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX1a rebin ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      enddo                     ! n
      if(badpnt) print '(a,2i5,10g14.7)','XXX1b rebin ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
      ...
      enddo                     ! n
      if(badpnt) print '(a,2i5,10g14.7)','XXX1c rebin ',ijb(1:2),vicen,aicen
...
! authors: William H. Lipscomb and Elizabeth C. Hunke, LANL
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX1 shift_ice ',ijb(1:2),vicen,aicen
      if(badpnt) print '(a,2i5,10g14.7)','XXX1a shift_ice ',ijb(1:2),dvice,daice
      do n = 1, ncat-1
         ...
         dvice_greater_vicen = .false.
            ...
            if (donor(n) > 0) then
               ...
               if (dvice(n) < c0) then
                  if (dvice(n) > -puny*vicen(nd)) then
                     ...
                     dvice_negative = .true.
                     if (badpnt) print '(a,4i6,2g15.7)','XXX1 shift_ice ',ijb(1:2),n,nd,dvice(n),-puny*vicen(nd)
                  endif
               endif
            ...
            !if (badpnt) print *,'YYY ',daice_negative,dvice_negative,daice_greater_aicen,dvice_greater_vicen
      !-----------------------------------------------------------------
      ! error messages
      !-----------------------------------------------------------------
...
! author: William H. Lipscomb, LANL
      ...
      !-----------------------------------------------------------------
         ...
         elseif (abs(aicen(n)) <= puny .and. &
                (abs(aicen(n)) /= c0 .or. abs(vicen(n)) /= c0))  then
      !-----------------------------------------------------------------
