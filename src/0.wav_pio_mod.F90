...
contains
  ...
  subroutine wav_pio_init(gcomp, mpi_comm, stdout, rc)
    ...
    use ESMF         , only : ESMF_Info, ESMF_InfoGet, ESMF_InfoGetFromHost
    ...
    if (ChkErr(rc,__LINE__,u_FILE_u)) return
    lnaproc = naproc/num_threads
    print *, iaproc,' XXX2 ',num_threads,naproc,lnaproc
    ...
    print *,iaproc,' XXX 3 ',trim(cvalue)
    ...
    print *,iaproc,' XXX 4 ',trim(cvalue)
    ! pio_root
    ...
    print *,iaproc,' XXX 7 ',pio_numiotasks
