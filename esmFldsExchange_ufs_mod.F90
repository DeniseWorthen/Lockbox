  ...
  subroutine esmFldsExchange_ufs(gcomp, phase, rc)
    ...
    do n = 1,size(flds)
       ...
       if (phase == 'advertise') then
          ...
          if ( fldchk(is_local%wrap%FBexp(compocn)        , fldname, rc=rc) .and. &
             ...
             !call addmap_from(compwav, fldname, compocn, mapbilnr_nstod, 'one', 'map.global_270k.to.mx100.bilnr_nstod.nc')
    ...
    do n = 1,size(flds)
       ...
       if (phase == 'advertise') then
          ...
          if ( fldchk(is_local%wrap%FBexp(compwav)        , fldname, rc=rc) .and. &
               fldchk(is_local%wrap%FBImp(compatm,compatm), fldname, rc=rc)) then
             !call addmap_from(compatm, fldname, compwav, mapbilnr, 'one', 'map.C96.to.global_270k.bilnr.nc')
    ...
    do n = 1,size(flds)
       ...
       if (phase == 'advertise') then
          ...
          if ( fldchk(is_local%wrap%FBexp(compwav)        , fldname, rc=rc) .and. &
               fldchk(is_local%wrap%FBImp(compice,compice), fldname, rc=rc)) then
             !call addmap_from(compice, fldname, compwav, mapbilnr_nstod , 'one', 'map.mx100.to.global_270k.bilnr_nstod.nc')
    ...
    do n = 1,size(flds)
       ...
       if (phase == 'advertise') then
          ...
          if ( fldchk(is_local%wrap%FBexp(compwav)        , fldname, rc=rc) .and. &
               fldchk(is_local%wrap%FBImp(compocn,compocn), fldname, rc=rc)) then
             !call addmap_from(compocn, fldname, compwav, mapbilnr_nstod , 'one', 'map.mx100.to.global_270k.bilnr_nstod.nc')
