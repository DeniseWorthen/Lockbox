...
! author: William H. Lipscomb, LANL
      ...
      if(badpnt) print '(a,2i5,10g14.7)','AAA0 start dynridg ',ijb(1:2),vicen,aicen
...
!autodocument_end
      ...
      if(badpnt) print '(a,2i5,10g15.7)','AAA1a b4 ridge_ice ',ijb(1:2),vicen,aicen
      ...
      if(badpnt) print '(a,2i5,10g15.7)','AAA1b af ridge_ice ',ijb(1:2),vicen,aicen
      !-----------------------------------------------------------------
