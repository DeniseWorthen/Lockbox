...
use ESMF,                   only : ESMF_Alarm, ESMF_TimeInterval, ESMF_Time
...
type :: outputlog_config_type
  ...
  character(len=:), allocatable :: outputdir
...
type :: outputlog_model_time_type
...
end type outputlog_model_time_type
...
!! @param[in]   isroot    logical    if (isroot) then
