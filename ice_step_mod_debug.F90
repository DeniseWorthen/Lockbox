...
! authors: William H. Lipscomb, LANL
      ...
      do i = ilo, ihi
         ...
         if (tmask(i,j,iblk)) then
            if(badpnt) print '(a,3i5,10g14.7)','YYY1a therm1 ',istep,ijb(1:2),(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         ...
         if(badpnt) print '(a,3i5,10g14.7)','YYY1b therm1 ',istep,ijb(1:2),(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      !-----------------------------------------------------------------
...
!          Elizabeth C. Hunke, LANL
      ...
      do i = ilo, ihi
         ...
         if(badpnt) print '(a,3i5,10g14.7)','YYY2a therm2 ',istep,ijb(1:2),(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         ...
         if(badpnt) print '(a,3i5,10g14.7)','YYY2b therm2 ',istep,ijb(1:2),(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      enddo                     ! i
      enddo                     ! j
...
!     use ice_grid, only: tmask
      ...
      if (my_task == 60) then
         i = 21; j = 467; iblk=1
         print '(a,3i5,10g14.7)','YYY3a upstate ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         i = 21; j = 468; iblk=1
         print '(a,3i5,10g14.7)','YYY3a upstate ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      end if
...
!        if (tmask(i,j,iblk)) &
      ...
      if (my_task == 60) then
         i = 21; j = 467; iblk=1
         print '(a,3i5,10g14.7)','YYY3b upstate ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         i = 21; j = 468; iblk=1
         print '(a,3i5,10g14.7)','YYY3b upstate ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      end if
      call icepack_warnings_flush(nu_diag)
...
!          Elizabeth C. Hunke, LANL
      ...
      if (my_task == 60) then
         i = 21; j = 467; iblk=1
         print '(a,3i5,10g14.7)','YYY4a dynhoriz ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         i = 21; j = 468; iblk=1
         print '(a,3i5,10g14.7)','YYY4a dynhoriz ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      end if
      !-----------------------------------------------------------------
      ...
      if (my_task == 60) then
         i = 21; j = 467; iblk=1
         print '(a,3i5,10g14.7)','YYY4b dynhoriz ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
         i = 21; j = 468; iblk=1
         print '(a,3i5,10g14.7)','YYY4b dynhoriz ',istep,i,j,(vicen(i,j,n,iblk),n=1,5),(aicen(i,j,n,iblk),n=1,5)
      end if
...
!          Elizabeth C. Hunke, LANL
      ...
      if (my_task == 60) then
         i = 21; j = 467
         print '(a,3i5,10g14.7)','YYY5a dynridg ',istep,i,j,(vicen(i,j,n,1),n=1,5),(aicen(i,j,n,1),n=1,5)
         i = 21; j = 468
         print '(a,3i5,10g14.7)','YYY5a dynridg ',istep,i,j,(vicen(i,j,n,1),n=1,5),(aicen(i,j,n,1),n=1,5)
      end if
      !-----------------------------------------------------------------
...
!      if (atmp > c0) then
      ...
      if (my_task == 60) then
         i = 21; j = 467
         print '(a,3i5,10g14.7)','YYY5b dynridg ',istep,i,j,(vicen(i,j,n,1),n=1,5),(aicen(i,j,n,1),n=1,5)
         i = 21; j = 468
         print '(a,3i5,10g14.7)','YYY5b dynridg ',istep,i,j,(vicen(i,j,n,1),n=1,5),(aicen(i,j,n,1),n=1,5)
      end if
      call icepack_warnings_flush(nu_diag)
