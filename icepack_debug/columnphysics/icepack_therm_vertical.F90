...
!         C. M. Bitz, UW
      ...
      if(badpnt) print '(a,2i5,10g14.7)','XXX3 init_vertical_profile ',ijb(1:2),vicen,aicen
      ...
      enddo                     ! nilyr
      if(badpnt) print '(a,2i5,10g14.7)','XXX3b init_vertical_profile ',ijb(1:2),vicen,aicen
