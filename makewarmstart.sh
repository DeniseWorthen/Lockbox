...
# From control run
sorc=/work2/noaa/stmp/dworthen/REGRESSION_TEST/cpld_control_${ares}_intel/RESTART
...
# CMEPS
dest=/work2/noaa/stmp/dworthen/input-data-20240501/CMEPS_IC/${ares}mx${ores}/2021032306
...
#FV3 restarts
dest="/work2/noaa/stmp/dworthen/input-data-20240501/FV3_input_data12/INPUT_L41_mx900/2021032306"
