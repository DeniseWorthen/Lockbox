...
module wav_pio_mod
  ...
  use mpi_f08
  use wav_comp_nuopc , only : wave_communicator
...
contains
  ...
  !> @author Denise.Worthen@noaa.gov
  !> @date 08-02-2024
  subroutine wav_pio_init(gcomp, mpi_commi, stdout, numprocs, rc)
    ...
    !wave_communicator%mpi_val = mpi_commi
#ifdef CESMCOUPLED
    ! TODO: needs testing
    ...
    call pio_init(my_task, wave_communicator%mpi_val, pio_numiotasks, master_task, pio_stride, pio_rearranger, &
