...
! Export Fields ----------------------------------------
  ...
  type(FieldInfo), dimension(NexportFields), public, parameter :: exportFieldsInfo = [ &
    ...
    FieldInfo("mean_net_lw_flx                          ", "s", "all       "), &
    FieldInfo("mean_net_sw_flx                          ", "s", "all       "), &
    FieldInfo("inst_net_lw_flx                          ", "s", "all       "), &
    FieldInfo("inst_net_sw_flx                          ", "s", "all       "), &
    FieldInfo("mean_down_sw_ir_dir_flx                  ", "s", "all       "), &
    FieldInfo("mean_down_sw_ir_dif_flx                  ", "s", "all       "), &
    FieldInfo("mean_down_sw_vis_dir_flx                 ", "s", "all       "), &
    FieldInfo("mean_down_sw_vis_dif_flx                 ", "s", "all       "), &
    ...
    FieldInfo("mean_net_sw_ir_dir_flx                   ", "s", "all       "), &
    FieldInfo("mean_net_sw_ir_dif_flx                   ", "s", "all       "), &
    FieldInfo("mean_net_sw_vis_dir_flx                  ", "s", "all       "), &
    FieldInfo("mean_net_sw_vis_dif_flx                  ", "s", "all       "), &
    FieldInfo("inst_net_sw_ir_dir_flx                   ", "s", "all       "), &
    FieldInfo("inst_net_sw_ir_dif_flx                   ", "s", "all       "), &
    FieldInfo("inst_net_sw_vis_dir_flx                  ", "s", "all       "), &
    FieldInfo("inst_net_sw_vis_dif_flx                  ", "s", "all       "), &
...
! Import Fields ----------------------------------------
  ...
  type(FieldInfo), dimension(NimportFields), public, parameter :: importFieldsInfo = [ &
    ...
    FieldInfo("wave_z0_roughness_length                 ", "s","all       ") &
    FieldInfo("inst_tracer_diag_aod                     ", "s","all       ") &
!IVAI: import canopy fields from AQM component
    FieldInfo("inst_tracer_diag_claie                   ", "s","all       ") &
    FieldInfo("inst_tracer_diag_cfch                    ", "s","all       ") &
    FieldInfo("inst_tracer_diag_cfrt                    ", "s","all       ") &
    FieldInfo("inst_tracer_diag_cclu                    ", "s","all       ") &
    FieldInfo("inst_tracer_diag_cpopu                   ", "s","all       ") &
!IVAI: import photolysis diagnostics from AQM component
    FieldInfo("inst_tracer_diag_coszens                 ", "s","all       ") &
    FieldInfo("inst_tracer_diag_jo3o1d                  ", "s","all       ") &
    FieldInfo("inst_tracer_diag_jno2                    ", "s","all       ") &
!IVAI
    FieldInfo("ocn_current_zonal                        ", "s","all       ") &
    FieldInfo("ocn_current_merid                        ", "s","all       ") &

    ! For receiving fluxes from mediator
    FieldInfo("stress_on_air_ocn_zonal                  ", "s","all       ") &
    FieldInfo("stress_on_air_ocn_merid                  ", "s","all       ") &
    FieldInfo("laten_heat_flx_atm_into_ocn              ", "s","all       ") &
    FieldInfo("sensi_heat_flx_atm_into_ocn              ", "s","all       ") &
    FieldInfo("lwup_flx_ocn                             ", "s","all       ") &

    ! For receiving fluxes from external land component
    FieldInfo("land_fraction                            ", "s","all       ") &
    FieldInfo("inst_snow_area_fraction_lnd              ", "s","all       ") &
    FieldInfo("inst_spec_humid_lnd                      ", "s","all       ") &
    FieldInfo("inst_laten_heat_flx_lnd                  ", "s","all       ") &
    FieldInfo("inst_sensi_heat_flx_lnd                  ", "s","all       ") &
    FieldInfo("inst_potential_laten_heat_flx_lnd        ", "s","all       ") &
    FieldInfo("inst_temp_height2m_lnd                   ", "s","all       ") &
    FieldInfo("inst_spec_humid_height2m_lnd             ", "s","all       ") &
    FieldInfo("inst_upward_heat_flux_lnd                ", "s","all       ") &
    FieldInfo("inst_runoff_rate_lnd                     ", "s","all       ") &
    FieldInfo("inst_subsurface_runoff_rate_lnd          ", "s","all       ") &
    FieldInfo("inst_drag_wind_speed_for_momentum        ", "s","all       ") &
    FieldInfo("inst_drag_mass_flux_for_heat_and_moisture", "s","all       ") &
    FieldInfo("inst_func_of_roughness_length_and_vfrac  ", "s","all       ") &
    ...
    ! For FIRE
    FieldInfo("hflx_fire                                ", "s","all       ") &
    FieldInfo("evap_fire                                ", "s","all       ") &
    FieldInfo("smoke_fire                               ", "s","all       ") ]
